...
% Map Unicode minus to ASCII hyphen
...
\minipage{0.24\textwidth}
  ...
  %\caption{FGSM1 - eps 0.1}\label{fig:awesome_image2}
\endminipage\hfill
\minipage{0.24\textwidth}
  \includegraphics[width=\linewidth]{Report_Img/fgsm1_0.2_adv.png}
  %\caption{FGSM1 - eps 0.2}\label{fig:awesome_image2}
\endminipage\hfill
\minipage{0.24\textwidth}%
  \includegraphics[width=\linewidth]{Report_Img/fgsm1_0.3_adv.png}
  %\caption{FGSM1 - eps 0.3}\label{fig:awesome_image3}
\endminipage
